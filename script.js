...
var eventTypes=["mouseup","mousedown","touchstart","touchend"];
...
checkEvent = function (event) {
  ...
  if (element.getAttributeNames().filter(a => a == "action").length == 0) {
      console.log("Target Element doesnt have action");
      return;
  }
